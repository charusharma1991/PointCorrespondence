function [P,A,ptR,ptC,tim] = matchHasseEllipse(H1,H2,cliques1,cliques2,coord1,coord2,nodes,nv1,nv2)
node=[];
...
for i=1:2
    ...
    [H{i}, MNeighborhood{i}, MNeighborCoeff{i}] = Ellipsoidal_Weights( d, aa );
    num{i}=size(H{i},1);
    if ~isempty(ptR{i})
